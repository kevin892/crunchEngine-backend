...
class SearchTermsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create search_term" do
    assert_difference('SearchTerm.count') do
      post search_terms_url, params: { search_term: { search: @search_term.search, type: @search_term.type, user_id: @search_term.user_id } }, as: :json
    end
  ...
  test "should update search_term" do
    patch search_term_url(@search_term), params: { search_term: { search: @search_term.search, type: @search_term.type, user_id: @search_term.user_id } }, as: :json
    assert_response 200
  end
